...
if geslacht == 'man':
    gewicht = int(input('hoe zwaar weegt u? '))
    if gewicht >= 90:
...
if (dieren_dressuur >= 4 or jongleren >= 5 or acrobatiek >= 3) and diploma == 'ja' and Truck_license == 'ja' and hoed == 'ja' and lengte >=150 and gewicht >= 90 and (geslacht =='man' and snor =='ja' and snor2 >=10 ):
#(dieren_dressuur >= 4 or jongleren >= 5 or acrobatiek >= 3) and lengte >=150 and gewicht >=90 and diploma =='ja' and Truck_license == 'ja' and hoed == 'ja' or(geslacht == 'man' and snor == 'ja' and snor2 >=10 and Certificaat == 'ja') or(redHair =='ja' and Certificaat == 'ja'and haarlengte >=20 and geslacht =='vrouw'): 
