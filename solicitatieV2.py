...
if (dieren_dressuur >= 4 or jongleren >= 5 or acrobatiek >= 3)and(gewicht >=90 and lengte >=150 and diploma =='ja' and Truck_license == 'ja' and hoed == 'ja' and(geslacht == 'man' and snor == 'ja' and snor2 >=10) or(redHair =='ja'and haarlengte >=20 and geslacht =='vrouw')): 
#if (dieren_dressuur >= 4 or jongleren >= 5 or acrobatiek >= 3)and (diploma =='ja' and Truck_license == 'ja' and hoed == 'ja' and geslacht == 'man' and geslacht == 'vrouw' and lengte >= 150 and gewicht >= 90 and snor2 >=10 and haarlengte >=20 ) :
